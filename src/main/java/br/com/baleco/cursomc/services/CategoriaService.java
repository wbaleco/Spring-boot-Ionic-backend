...
import br.com.baleco.cursomc.services.exceptions.DataIntegrityException;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir uma categoria que contenha produtos cadastrados");
